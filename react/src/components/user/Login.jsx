    ...
    promise
      .then((res) => {
        if (res?.payload?.jwttoken) {
          ...
          if (res?.payload?.data.type === "admin") {
            nav("/staff");
          } else {
            nav("/dashboard");
          }
  ...
  return (
    <div>
      <div className="text-center flex justify-center   ">
        <Paper
          sx={{ maxWidth: "700px", minWidth: "450px", padding: "10px" }}
          elevation={3}
        >
          <h1 className="font-size-8">Welcome Again</h1>
          ...
          <h1 className="bg-red-200">
            Don't have Account{" "}
            <span>
              <NavLink to="/register" className="text-red-500 p-2">
                Register Now
              </NavLink>
            </span>{" "}
          </h1>
